          ...
          <div className="p-6">
            ...
            {community.memberInfo?.role && (
              <div className="mt-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary/10 text-primary">
                {community.memberInfo.role.charAt(0).toUpperCase() +
                  community.memberInfo.role.slice(1)}
              </div>
            )}
          </div>
        </div>
          ...
          <div className="space-y-4">
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                ...
                <p>
                  {t("community.page.created")} {new Date(community.createdAt).toLocaleDateString()}
                </p>
              </CardContent>
            </Card>
