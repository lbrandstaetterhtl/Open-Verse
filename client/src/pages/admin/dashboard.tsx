                    ...
                    <div className="relative overflow-hidden rounded-b-lg">
                      <div className="overflow-auto h-[600px]">
                        <Table>
                          <TableHeader className="sticky top-0 bg-card z-20 border-b">
                            <TableRow>
                              <TableHead className="w-[140px]">{t('admin.reports_table.reporter')}</TableHead>
                              <TableHead className="w-[140px]">{t('admin.reports_table.ip_address')}</TableHead>
                              <TableHead className="w-[140px]">{t('admin.reports_table.poster')}</TableHead>
                              ...
                              <TableHead className="w-[200px]">{t('admin.reports_table.reason')}</TableHead>
                              <TableHead className="w-[100px]">{t('admin.reports_table.status')}</TableHead>
                              <TableHead className="w-[160px]">{t('admin.reports_table.reported_on')}</TableHead>
                              <TableHead className="sticky right-0 bg-card w-[100px] z-20">{t('admin.reports_table.actions')}</TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            {filteredReports?.map((report) => (
                              ...
                              >
                                ...
                                <TableCell className="font-mono text-xs">{report.ipAddress || 'N/A'}</TableCell>
                                <TableCell>
