        ...
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-10 md:gap-16">
            <div className="space-y-6 md:space-y-8 flex-1 min-w-0">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl xl:text-[9rem] font-black tracking-tighter leading-[0.8] uppercase italic flex flex-col sm:block overflow-hidden">
