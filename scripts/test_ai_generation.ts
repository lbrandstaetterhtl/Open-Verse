...
async function testAIGeneration() {
    ...
    try {
        const content = await generatePostContent({ topic: "Sunny Days", imageContext: "has_image", language: "english" });
    ...
    try {
        const content = await generatePostContent({ topic: "Sommer", imageContext: "has_image", language: "german" });
