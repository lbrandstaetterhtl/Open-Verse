...
export const BANNED_WORDS = [
    // English - NSFW
    "porn", "sex", "nude", "naked", "xxx", "erotic", "hentai", "fuck", "dick", "pussy", "vagina", "penis", "sexual", "incest",
    // German - NSFW
    "porno", "sex", "nackt", "gefickt", "schwanz", "muschi", "ficken", "hure", "nutte", "fotze", "wichser", "arschloch",
    // Hate Speech / Violence (Basic list)
    "nazi", "hitler", "kill", "suicide", "murder", "mord", "töten", "selbstmord"
];
